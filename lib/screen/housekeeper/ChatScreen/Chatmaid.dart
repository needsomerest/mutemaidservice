...
import 'package:mutemaidservice/screen/housekeeper/ChatScreen/message.dart';

class Chatmaid extends StatefulWidget {
  String senderid;
  String receiverid;
  Chatmaid(this.senderid, this.receiverid);
  @override
  _ChatmaidState createState() => _ChatmaidState();
}

class _ChatmaidState extends State<Chatmaid> {
  late String code;
