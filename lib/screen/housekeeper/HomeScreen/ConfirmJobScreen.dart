...
class _ConfirmJobScreenState extends State<ConfirmJobScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //     ? Center(
      //         child: Text(
      //             widget.dataList[0]['Note']), //CircularProgressIndicator(),
      //       )
      //     :
              ...
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InfoJobAtom(
                          "assets/images/happy.png", widget.dataList[0]['Pet']),
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    VideoPlayerScreen(dataVideo[0]['Url'])));
                      },
                    )
                  ],
                ),
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    SuccessJob(widget.maid, widget.accept)));
                      },
                    ),
                  ],
                )
