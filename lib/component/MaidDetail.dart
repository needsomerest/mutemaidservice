...
class _MaidDetailState extends State<MaidDetail> {
  ...
  void initState() {
    ...
    checkfavhousekeeper(widget._uid, widget.HousekeeperID).then((result) {
      setState(() {
        ischeck = result;
      });
    });
                        ...
                        child: Column(
                          ...
                          children: [
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            ...
                                            if (icon_fav == Icons.bookmark) {
                                              createfav(UserID, newHousekeeper);
                                            } else if (icon_fav ==
                                                Icons.bookmark_border) {
                                              deletefav(
                                                  UserID, widget.HousekeeperID);
                                            }
                                          });
                                        }),
                                  ] else ...[
                            ...
                            Row(children: [
                              ...
                              Text(
                                  avgreview.isNaN ? '0' : avgreview.toString()),
                              Text(
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          widget.housekeeper.ProfileImage = widget.ProfileImage;
